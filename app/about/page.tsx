...
export const metadata: Metadata = pageSeo({
  title: "About",
  description:
    "Vozpar builds AI voice agents that actually sound human — carrier-grade, self-hosted, and sub-second. Operated by Rozper across the USA, Europe, UK, and Latin America.",
  path: "/about",
})
        ...
        <ScrollReveal className="grid gap-8 rounded-2xl border border-border/60 bg-card/30 p-8 md:grid-cols-2 md:p-12">
          <div>
            ...
            <p className="mt-3 text-pretty leading-relaxed text-muted-foreground">
              Vozpar is operated by <strong className="text-foreground">Rozper</strong>, with voice infrastructure spanning the USA, Europe, the UK, and Latin America. We
