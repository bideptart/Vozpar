  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-border/50 bg-black">
        ...
        <ParticleField />
        <FloatingIconBadges />
        <div className="relative mx-auto w-full max-w-6xl px-4 py-10 md:px-6 md:py-24">
                ...
                {group.items.map((item, i) => {
                  ...
                  return (
                    <AccordionItem
                      key={i}
                      value={`${group.id}-${i}`}
                      className={`group/faq relative overflow-hidden rounded-2xl bg-[#0b0b0e] border border-white/15 px-6 py-1 transition-all duration-300 ease-out ${theme.hoverBorder}`}
                    >
